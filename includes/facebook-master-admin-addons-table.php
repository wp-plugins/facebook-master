...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td class="column-columnname"style="vertical-align:middle"><h3>Facebook Master Responsive Embed Post Widget</h3><p>Embed your favourite Public Posts from User Profiles or Facebook Fan Pages.</p><p>Fully Mobile Responsive. Awesome for photos.</p></td>
			<td class="column-columnname" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-check-no.png', __FILE__); ?>" alt="<?php echo get_option('facebook_master_name'); ?>" align="left" width="200px" height="121px" style="padding:5px;"/></td>
		</tr>
		<tr class="alternate">
