<div class="wrap">
<div class="icon32" style="width:40px; vertical-align:middle;"><img src="../wp-content/plugins/facebook-master/techgasp-minilogo.png" alt="' . esc_attr__( 'TechGasp Plugins') . '" /><br /></div>

<h2><b>TechGasp - Facebook Master Lite Version</b></h2>
<form method="post" action="techgasp-facebookmaster-admin.php"> 
...
<img src="../wp-content/plugins/facebook-master/techgasp-facebookmaster-logo.png" alt="Facebook Master" align="left" width="387px" height="171px" style="padding:5px;"/>
<p><h2>Facebook Master:</h2></p>
<p>Facebook Master let's you have full control over all good facebook social plugins in one go, only for professional wordpress websites.</p>
</br>
<p><em>The Ultimate facebook plugin for any wordpress administrator...</em><p>
</br>
</br>
<p><h3>Options & Configuration:</h3></p>
<p><b>All configuration options are available in your widgets page. Facebook Master Widget:</b></p>
<p>Select or <em>"add"</em > Facebook Master Widget. Configure your settings. Select widget position according to your template. That easy...</p>
<p><b>Insert Facebook Master Widget inside Pages and Posts (advanced version only):</b></p>
<p>Copy and Paste this shortcode inside your pages or posts [facebookmaster id=xx] replace xx with your sidebar number, ie [facebookmaster id=sidebar-1]</p>
<p><a class="button-primary" href="widgets.php" title="Widgets Page">To Widgets Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/facebook-master/" target="_blank" title="More Help">More Help</a> <a class="button-primary" href="http://wordpress.techgasp.com/facebook-master/" target="_blank" title="Facebook Master Advanced Version">Facebook Master Advanced Version</a></p>
<hr>
<p><h3>Facebook Master Advanced Version:</h3></p>
<p>Upgrade! and gain full plugin features and professional support.</p>
<p>Display or hide Widget Title. Display or hide Facebook Social Plugin. Facebook Fan Page or Application Address. Facebook Application ID number. Plugin Width. Plugin Height. Display Facebook User Faces. Display Facebook Stream. Display Facebook Header. Color Scheme. Display Border. Shortcode Framework. Publish widget inside pages and post.</p>
